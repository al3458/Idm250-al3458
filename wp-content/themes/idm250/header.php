    ...
    <div class="topnav">
        <div class="navbar">
            ...
            <nav role="navigation" class="nav">
                ...
                <a class="navlinks" id="active" href="http://localhost:8888/portfolio/" style="max-width: 940px;">Portfolio</a>
                <a class="navlinks" href="http://localhost:8888/resume/" style="max-width: 940px;">Resume</a>
